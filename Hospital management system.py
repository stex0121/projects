...
class Hospital:
    ...
    def prescription_data(self):
        ...
        if nameoftablets == '' or ref == '':
            ...
            try:
                my_cursor.execute('INSERT INTO hospital (nameoftablets, ref, dose, dob, lot, issuedate, expdate, dailydose, sideeffect, furtherinfo, storage, driving, prescription, nhsnumber, pname, adress) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', (
                    nameoftablets, ref, dose, dob, lot, issue_date, exp_date, daily_dose, "side_effect", further_information, "storage_advice", "driving_using_machine", how_to_use_medication, nhs_number, patient_name, patient_address))
                conn.commit()
