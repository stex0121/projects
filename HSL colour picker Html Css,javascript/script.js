document.addEventListener("DOMContentLoaded", function(){
    ...
    const colorDisplay = document.querySelector(".color-display"); // Corrected selector
    ...
    function updateColor(){
        ...
        const color = `hsl(${hue}, ${saturation}%, ${lightness}%)`; // Corrected string interpolation syntax
    ...
    function copyToClipboard(){
        const textToCopy = `hsl(${hueInput.value}, ${saturationInput.value}%, ${lightnessInput.value}%)`; // Corrected string interpolation syntax
